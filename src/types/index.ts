...
export { ApiTypes, V1, V3 } from './generated';
...
/**
 * @deprecated Use ApiTypes.V1.ContentItem or ApiTypes.V3.ContentItem instead
 * This will be removed in v4.0.0
 */
export type ContentItem<T = { [key: string]: any }> = ApiTypes.V1.ContentItem;

/**
 * @deprecated Use ApiTypes.V1.Page or ApiTypes.V3.Page instead
 * This will be removed in v4.0.0
 */
export type Page = ApiTypes.V1.Page;

/**
 * @deprecated Use ApiTypes.V1.Gallery or ApiTypes.V3.Gallery instead
 * This will be removed in v4.0.0
 */
export type Gallery = ApiTypes.V1.Gallery;

/**
 * @deprecated Use ApiTypes.V1.MediaItem or ApiTypes.V3.MediaItem instead
 * This will be removed in v4.0.0
 */
export type MediaItem = ApiTypes.V1.MediaItem;

/**
 * @deprecated Use ApiTypes.V1.SitemapFlat or ApiTypes.V3.SitemapFlat instead
 * This will be removed in v4.0.0
 */
export type SitemapFlat = ApiTypes.V1.SitemapFlat;

/**
 * @deprecated Use ApiTypes.V1.SitemapNested or ApiTypes.V3.SitemapNested instead
 * This will be removed in v4.0.0
 */
export type SitemapNested = ApiTypes.V1.SitemapNested;

/**
 * @deprecated Use ApiTypes.V1.ContentList or ApiTypes.V3.ContentList instead
 * This will be removed in v4.0.0
 */
export type ContentList = ApiTypes.V1.ContentList;

/**
 * @deprecated Use ApiTypes.V1.ContentItemSync or ApiTypes.V3.ContentItemSync instead
 * This will be removed in v4.0.0
 */
...
/**
 * @deprecated Use ApiTypes.V1.UrlRedirection or ApiTypes.V3.UrlRedirection instead
 * This will be removed in v4.0.0
 */
